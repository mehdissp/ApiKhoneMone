...
public class MenuPermissionMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context, AppDbContext _context)
    {
        ...
        var publicPaths = new[] { "/api/auth/verify-otp", "/api/auth/send-otp", "/api/realestatepage/getrealestatedetails", "/api/realestatepage/getcategorydtos", "/uploads/images", "/api/realestatepage/getrandomlastitemrealestates", "/api/auth/login", "/api/auth/register", "/swagger" , "/api/auth/captcha", "/api/auth/verify-captcha", "/api/UserProfile/upload-photo", "/api/payment/request", "/api/payment/test", "/api/aqayepardakht/request", "/api/userprofile/uploadphoto" };
